...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            html.Iframe(id = 'iframe-msg',srcDoc='The quick brown fox jumps over the lazy dog',width = 450,style=dict(className= 'eigth columns',textAlign='center')),
            
            html.Label('Please type the content here:'),
            dcc.Input(id = 'cur_loc', value='', type='text',className = 'eigth columns'),
                  
            html.Div(id='typing_indictor', children = '',style = dict(className = 'eigth columns',fontSize='15px', textAlign='center')),
...
def update_message(click,curloc, start):
    ## call backend function and return description of the nearest hydrant
